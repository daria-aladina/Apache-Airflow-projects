...
<p dir="auto"><b>Задача: Создать DAG в Airflow с ETL-пайплайном, который будет считаться каждый день за вчера.</b> <br> Требования к пайплайну:</p>
  <ol>
...
<p dir="auto"><b>Задача: Наладить автоматическую ежедневную отправку аналитической сводки с данными по метрикам ленты за последние 7 дней в Telegram. </b> <br> Требования к отчёту:</p>
  <ol>
